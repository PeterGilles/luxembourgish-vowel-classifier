...
if audio_source == "Upload WAV file":
    ...
    def load_example_vowels(max_per_class=5):
        vowel_examples = {}
        # Look in parent directory for exported_vowels (supports both original and organized structure)
        parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        exported_vowels_dir = os.path.join(parent_dir, "exported_vowels")
